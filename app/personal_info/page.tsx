    ...
    return (
        <div className={styles.pageWrapper}>
            ...
            <header className={styles.header}>
                <div className={styles.stepInfo}>Step 1 of 5</div>
                <div className={styles.titleRow}>
                    <h1 className={styles.title}>Personal Information</h1>
                    <div className={styles.percentageBadge}>20% Complete</div>
                </div>
            ...
            <main className={styles.formCard}>
                <div className={styles.infoBox}>
                    <p className={styles.infoText}>
                        Help us understand your background to provide a tailored experience. Your data is stored ethically and with full dignity.
                    </p>
                </div>
                    ...
                    <div className={styles.religiousSection}>
                        <div className={styles.religiousHeader}>
                            <div className={styles.religiousTitle}>
                                ...
                                Religious Practice (Optional)
                            </div>
                            <div className={styles.visibilityBadge}>
                                <span className={styles.visibilityLabel}>Profile Visibility</span>
                        ...
                        <div className={styles.selectWrapper}>
                            <select 
                                ...
                                onChange={handleChange}
                            >
                                <option>Preference for prayer facilities / Halal food?</option>
                                <option>Yes, I require prayer facilities</option>
                                <option>Yes, I require Halal food options</option>
                                <option>Both are important to me</option>
                            </select>
                        </div>

                        <p className={styles.privacyNote}>
                            Your religious details are used only for matching with faith-aligned employers and are hidden from the public profile unless you choose otherwise. Data is encrypted for your dignity and privacy.
                        </p>
                    </div>
